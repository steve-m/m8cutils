...
#define	INIT_VECTOR	WRITE_REG(0x54,0)
...
#define VECTOR_PTROP_PREAMBLE(pointer) \
  WRITE_REG(CPU_F,16) \
  WRITE_REG(CPU_CODE2,0) \
  WRITE_REG(CPU_F,0) \
  WRITE_REG(CPU_F,16) \
  WRITE_REG(CPU_SCR1, 0x04) \
  WRITE_REG(INT_VC,0x04) \
  WRITE_REG(INT_MSK0,3) \
  WRITE_REG(CPU_F,0) \
  ...
  WRITE_MEM(RESERVED_FD,1) \
  WRITE_MEM(RESERVED_FF,1) \
  WRITE_MEM(RESERVED_FF,0x80) \
  WRITE_REG(CPU_F,16) \
  WRITE_REG(INT_VC,0) \
  WRITE_REG(CPU_SCR1,0) \
  WRITE_REG(INT_MSK0,0) \
  WRITE_REG(CPU_F,0) \
  WRITE_REG(CPU_PCL,3) \
  WRITE_REG(CPU_PCH,0) \
  WRITE_REG(CPU_SP,0) \
  WRITE_REG(CPU_CODE0,0) \
  WRITE_REG(CPU_CODE1,0x30)
